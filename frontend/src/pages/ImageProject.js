  ...
  const handleSendBatch = async () => {
    try {
        ...
        for (let i = 0; i < class1Images.length; i++) {
            ...
            console.log(`Class1 Image ${i} Upload Response:`, uploadResponse);
        }
        ...
        for (let i = 0; i < class2Images.length; i++) {
            ...
            console.log(`Class2 Image ${i} Upload Response:`, uploadResponse);
        }
    ...
    try {
      if (predictionWebcamRef.current) {
        ...
        if (response.data.error) {
          ...
          setPredictionResult(
            `Predicted Class: ${response.data.predicted_class}, Confidence: ${(
